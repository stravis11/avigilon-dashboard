...
The test frontend runs at https://gtpd-synopta.police.gatech.edu:8443/camera-stats and shares the existing backend on gtpd-synopta. Log in with the usual dashboard account. The existing frontend on port 443 remains in place.
...
To remove only this test frontend:
